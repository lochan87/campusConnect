      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              <FiMenu className="w-5 h-5 text-gray-600 group-hover:text-gray-800" />
            </button>
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link
              to="/leaderboard"
              className="hidden sm:flex items-center space-x-1 px-3 py-2 rounded-lg hover:bg-gray-100 transition-colors"
            >
                    ...
                    {unreadCount === 0 ? (
                      ...
                      <div className="py-2">
                        ...
                        <div className="px-4 py-2 hover:bg-gray-50 cursor-pointer">
                          <p className="text-sm text-gray-800">Sample notification</p>
